...
use app\assets\IndexxAsset;
IndexxAsset::register($this);
...
<div class="block-video">
    <div class="xx">
        <?php foreach ($videoModel as $video) : ?>
            <video playsinline controls loop class="vivi" id="vivi">
...
<nav class="nav">
    <label id="click-to-hide" for="nav-toggle" class="nav-toggle"></label>
    <h2 class="logo">
